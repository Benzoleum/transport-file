...
public class FileParsingServiceTest {
    ...
    MockMultipartFile missingUuidInOneLine = new MockMultipartFile("test.txt", "test.txt", "text/plain",
            ("1X1D14|John Smith|Likes Apricots|Rides A Bike|6.2|12.1\n" +
                    "3ce2d17b-e66a-4c1e-bca3-40eb1c9222c7|2X2D24|Mike Smith|Likes Grape|Drives an SUV|35.0|95.5\n" +
                    "1afb6f5d-a7c2-4311-a92d-974f3180ff5e|3X3D35|Jenny Walters|Likes Avocados|Rides A Scooter|8.5|15.3")
                    .getBytes());

    MockMultipartFile stringInsteadOfDouble = new MockMultipartFile("test.txt", "test.txt", "text/plain",
    ...
    @Test
    public void testMissingUuidOnOneLine() {
        assert (fileParsingService.parseIncomingFile(missingUuidInOneLine) == null);

    }

    @Test
    public void testStringInsteadOfDouble() {
        assert (fileParsingService.parseIncomingFile(stringInsteadOfDouble) == null);
